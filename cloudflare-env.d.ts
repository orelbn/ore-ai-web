/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 77ddb55e5aac1fdafe83a26b3001426e)
// Runtime types generated with workerd@1.20260312.1 2026-02-25 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "RateLimiterDurableObject";
	}
	interface ProductionEnv {
		AGENT_PROMPTS: R2Bucket;
		AUTH_DB: D1Database;
		...
		RATE_LIMITER: DurableObjectNamespace<import("./src/server").RateLimiterDurableObject>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "OAUTH_GOOGLE_CLIENT_ID" | "OAUTH_GOOGLE_CLIENT_SECRET" | "MCP_INTERNAL_SHARED_SECRET" | "MCP_SERVER_URL" | "AGENT_PROMPT_KEY" | "GOOGLE_GENERATIVE_AI_API_KEY" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "SESSION_ACCESS_SECRET" | "MESSAGE_INTEGRITY_SECRET">> {}
}
