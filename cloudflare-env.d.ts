/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 38728237573902a7a4300e507240a3b9)
...
declare namespace Cloudflare {
	interface ProductionEnv {
		...
		LOCAL_TEST_AUTH_ENABLED: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "OAUTH_GOOGLE_CLIENT_ID" | "OAUTH_GOOGLE_CLIENT_SECRET" | "MCP_INTERNAL_SHARED_SECRET" | "MCP_SERVER_URL" | "AGENT_PROMPT_KEY" | "LOCAL_TEST_AUTH_ENABLED">> {}
}
