/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 527aa1604c2baf2fb20ea25397cfb0b5)
// Runtime types generated with workerd@1.20260405.1 2026-02-25 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		TRANSCRIPTION_USER_QUOTA: RateLimit;
		TRANSCRIPTION_IP_QUOTA: RateLimit;
		AI: Ai;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "AGENT_PROMPT_KEY" | "GOOGLE_GENERATIVE_AI_API_KEY" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY">> {}
}
